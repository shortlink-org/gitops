...
|------------|------|---------|
| oci://registry-1.docker.io/bitnamicharts | redis | 23.2.11 |
...
true
		...
		<tr>
			<td id="redis--metrics--prometheusRule--enabled"><a href="./values.yaml#L50">redis.metrics.prometheusRule.enabled</a></td>
			<td>
bool
</td>
			<td>
...
"64Mi"
		...
		<tr>
			<td id="redis--metrics--serviceMonitor--additionalLabels--release"><a href="./values.yaml#L37">redis.metrics.serviceMonitor.additionalLabels.release</a></td>
			<td>
string
</td>
			<td>
...
true
		...
		<tr>
			<td id="redis--metrics--serviceMonitor--podMonitor--additionalLabels--release"><a href="./values.yaml#L42">redis.metrics.serviceMonitor.podMonitor.additionalLabels.release</a></td>
			<td>
string
</td>
			<td>
...
"prometheus-operator"
		...
		<tr>
			<td id="redis--metrics--serviceMonitor--podMonitor--enabled"><a href="./values.yaml#L40">redis.metrics.serviceMonitor.podMonitor.enabled</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="redis--metrics--serviceMonitor--prometheusRule--additionalLabels--release"><a href="./values.yaml#L47">redis.metrics.serviceMonitor.prometheusRule.additionalLabels.release</a></td>
			<td>
string
</td>
			<td>
...
"prometheus-operator"
		...
		<tr>
			<td id="redis--metrics--serviceMonitor--prometheusRule--enabled"><a href="./values.yaml#L45">redis.metrics.serviceMonitor.prometheusRule.enabled</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="redis--replica--persistence--enabled"><a href="./values.yaml#L64">redis.replica.persistence.enabled</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="redis--replica--replicaCount"><a href="./values.yaml#L53">redis.replica.replicaCount</a></td>
			<td>
int
</td>
			<td>
...
0
		...
		<tr>
			<td id="redis--replica--resources--limits--cpu"><a href="./values.yaml#L57">redis.replica.resources.limits.cpu</a></td>
			<td>
string
</td>
			<td>
...
"500m"
		...
		<tr>
			<td id="redis--replica--resources--limits--memory"><a href="./values.yaml#L58">redis.replica.resources.limits.memory</a></td>
			<td>
string
</td>
			<td>
...
"256Mi"
		...
		<tr>
			<td id="redis--replica--resources--requests--cpu"><a href="./values.yaml#L60">redis.replica.resources.requests.cpu</a></td>
			<td>
string
</td>
			<td>
...
"10m"
		...
		<tr>
			<td id="redis--replica--resources--requests--memory"><a href="./values.yaml#L61">redis.replica.resources.requests.memory</a></td>
			<td>
string
</td>
			<td>
