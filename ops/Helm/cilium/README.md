...
false
		...
		<tr>
			<td id="cilium--cgroup--autoMount--enabled"><a href="./values.yaml#L60">cilium.cgroup.autoMount.enabled</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="cilium--cgroup--hostRoot"><a href="./values.yaml#L61">cilium.cgroup.hostRoot</a></td>
			<td>
string
</td>
			<td>
...
true
		...
		<tr>
			<td id="cilium--gatewayAPI--enabled"><a href="./values.yaml#L37">cilium.gatewayAPI.enabled</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="cilium--ipam--mode"><a href="./values.yaml#L34">cilium.ipam.mode</a></td>
			<td>
string
</td>
			<td>
...
true
		...
		<tr>
			<td id="cilium--operator--replicas"><a href="./values.yaml#L73">cilium.operator.replicas</a></td>
			<td>
int
</td>
			<td>
...
"prometheus-operator"
		...
		<tr>
			<td id="cilium--prometheus--enabled"><a href="./values.yaml#L64">cilium.prometheus.enabled</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="cilium--prometheus--serviceMonitor--enabled"><a href="./values.yaml#L67">cilium.prometheus.serviceMonitor.enabled</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="cilium--prometheus--serviceMonitor--labels--release"><a href="./values.yaml#L70">cilium.prometheus.serviceMonitor.labels.release</a></td>
			<td>
string
</td>
			<td>
...
true
		...
		<tr>
			<td id="cilium--securityContext--capabilities--ciliumAgent[0]"><a href="./values.yaml#L42">cilium.securityContext.capabilities.ciliumAgent[0]</a></td>
			<td>
string
</td>
			<td>
...
"CHOWN"
		...
		<tr>
			<td id="cilium--securityContext--capabilities--ciliumAgent[10]"><a href="./values.yaml#L52">cilium.securityContext.capabilities.ciliumAgent[10]</a></td>
			<td>
string
</td>
			<td>
...
"SETUID"
		...
		<tr>
			<td id="cilium--securityContext--capabilities--ciliumAgent[1]"><a href="./values.yaml#L43">cilium.securityContext.capabilities.ciliumAgent[1]</a></td>
			<td>
string
</td>
			<td>
...
"KILL"
		...
		<tr>
			<td id="cilium--securityContext--capabilities--ciliumAgent[2]"><a href="./values.yaml#L44">cilium.securityContext.capabilities.ciliumAgent[2]</a></td>
			<td>
string
</td>
			<td>
...
"NET_ADMIN"
		...
		<tr>
			<td id="cilium--securityContext--capabilities--ciliumAgent[3]"><a href="./values.yaml#L45">cilium.securityContext.capabilities.ciliumAgent[3]</a></td>
			<td>
string
</td>
			<td>
...
"NET_RAW"
		...
		<tr>
			<td id="cilium--securityContext--capabilities--ciliumAgent[4]"><a href="./values.yaml#L46">cilium.securityContext.capabilities.ciliumAgent[4]</a></td>
			<td>
string
</td>
			<td>
...
"IPC_LOCK"
		...
		<tr>
			<td id="cilium--securityContext--capabilities--ciliumAgent[5]"><a href="./values.yaml#L47">cilium.securityContext.capabilities.ciliumAgent[5]</a></td>
			<td>
string
</td>
			<td>
...
"SYS_ADMIN"
		...
		<tr>
			<td id="cilium--securityContext--capabilities--ciliumAgent[6]"><a href="./values.yaml#L48">cilium.securityContext.capabilities.ciliumAgent[6]</a></td>
			<td>
string
</td>
			<td>
...
"SYS_RESOURCE"
		...
		<tr>
			<td id="cilium--securityContext--capabilities--ciliumAgent[7]"><a href="./values.yaml#L49">cilium.securityContext.capabilities.ciliumAgent[7]</a></td>
			<td>
string
</td>
			<td>
...
"DAC_OVERRIDE"
		...
		<tr>
			<td id="cilium--securityContext--capabilities--ciliumAgent[8]"><a href="./values.yaml#L50">cilium.securityContext.capabilities.ciliumAgent[8]</a></td>
			<td>
string
</td>
			<td>
...
"FOWNER"
		...
		<tr>
			<td id="cilium--securityContext--capabilities--ciliumAgent[9]"><a href="./values.yaml#L51">cilium.securityContext.capabilities.ciliumAgent[9]</a></td>
			<td>
string
</td>
			<td>
...
"SETGID"
		...
		<tr>
			<td id="cilium--securityContext--capabilities--cleanCiliumState[0]"><a href="./values.yaml#L54">cilium.securityContext.capabilities.cleanCiliumState[0]</a></td>
			<td>
string
</td>
			<td>
...
"NET_ADMIN"
		...
		<tr>
			<td id="cilium--securityContext--capabilities--cleanCiliumState[1]"><a href="./values.yaml#L55">cilium.securityContext.capabilities.cleanCiliumState[1]</a></td>
			<td>
string
</td>
			<td>
...
"SYS_ADMIN"
		...
		<tr>
			<td id="cilium--securityContext--capabilities--cleanCiliumState[2]"><a href="./values.yaml#L56">cilium.securityContext.capabilities.cleanCiliumState[2]</a></td>
			<td>
string
</td>
			<td>
